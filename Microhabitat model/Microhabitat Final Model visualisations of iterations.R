...
#for this part, the model in script 'Microhabitat Final Model with iterations - scales.R' should first be run and output loaded here
...
#contour
DSN <- "./data/Study_Area_thesis.shp"
